...
def train_lr_baseline(X_train, y_train, X_test, cat_cols, feature_names):
    ...
    # Generate formula string (top 10)
...
def evaluate_layers(model_path, output_dir=None):
    ...
    # Check for training data (needed for LR baseline)
    ...
    # Create encoded version for XGB/LGBM/RF
    ...
    # Create native version for CatBoost
    ...
    # ─────────────────────────────────────────
    # 4. DETERMINE THRESHOLD (Youden's J on final output)
    # ─────────────────────────────────────────
    ...
    if has_train_data:
        ...
        # Use LR's own Youden threshold for fair comparison
    ...
    # ==========================================
    # LAYER 1: INDIVIDUAL ENSEMBLE MODELS
    # ==========================================
    print("\n" + "=" * 60)
    ...
    # ==========================================
    # LAYER 3: COMPLETE PIPELINE (Calibrated)
    # ==========================================
    print("\n" + "=" * 60)
...
if __name__ == "__main__":
    ...
    # parser = argparse.ArgumentParser(description="Evaluate TearSense model layers")
    # parser.add_argument("--model", type=str, required=True, help="Path to .pkl file")
    # args = parser.parse_args()
    # evaluate_layers(args.model)
